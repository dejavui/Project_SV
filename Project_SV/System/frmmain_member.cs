...
namespace Project_SV
{
    public partial class frmmain_member : Form
    {
        ...
        public frmmain_member(string Message) : this()
        {
            message = Message;
            txtnhan.Text = message;
        }
        ketnoidulieu kn = new ketnoidulieu();
        string UID = frmlogin.ID_USERS_member;
        ...
        {
            kn.myconn();
            Form frm = new frm_thong_tin(txtnhan.Text);
            this.Hide();
            frm.ShowDialog();
        }
        ...
        {
            kn.myconn();
            Form frm = new frm_xem_diem(txtnhan.Text);
            this.Hide();
            frm.ShowDialog();
        }
